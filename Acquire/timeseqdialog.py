...
class seqDialog(wxFrame):
    def _init_ctrls(self, prnt):
        ...
        wx.Frame.__init__(self, id=wxID_TSEQDIALOG, name='tseqDialog', parent=prnt,
    ...
    def __init__(self, parent, scope):
        ...
        if not ('ta' in self.scope.__dict__):
            self.scope.ta = timesequenceaquisator.TimeSequenceAquisitor(self.scope.chaninfo, self.scope.cam)

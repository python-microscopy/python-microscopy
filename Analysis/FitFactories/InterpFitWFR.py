...
class PSFFitFactory:
    ...
    #def __getitem__(self, key):
        ...
        if nchi20 < nchi21:
            ...
            return PSFFitResultR(res0, self.metadata,(xslice, yslice, zslice), resCode0, fitErrors, numpy.array(startParameters0), nchi20)
        else:
            fitErrors=None
            try:
            ...
            #print res, fitErrors, resCode
            #return PSFFitResultR(res, self.metadata, numpy.array((sig_xl, sig_xr, sig_yu, sig_yd)),(xslice, yslice, zslice), resCode, fitErrors, numpy.array(startParameters), nchi2)
            return PSFFitResultR(res1, self.metadata,(xslice, yslice, zslice), resCode1, fitErrors, numpy.array(startParameters1), nchi21)

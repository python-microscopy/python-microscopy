...
scope.piFoc = piezo_e816.piezo_e816('COM5', 400, 0, False)
...
scope.stage = mercuryStepper.mercuryStepper(comPort=4, baud=38400, axes=['A', 'B'], steppers=['M-229.25S', 'M-229.25S'])
...
splt = splitter.Splitter(MainFrame, mControls, scope, scope.cam, flipChan = 0, dichroic = 'FF741-Di01' , transLocOnCamera = 'Top', flip=False)
''')
...
InitGUI('''
try:
    scope.filterWheel = FiltFrame(MainFrame, filtList, 'COM8')
...
#scope.l642 = phoxxLaser.PhoxxLaser('642',portname='COM7')
#scope.StatusCallbacks.append(scope.l642.GetStatusText)

from PYME.Acquire.Hardware import lasers
sb = lasers.SBox(com_port='COM11')

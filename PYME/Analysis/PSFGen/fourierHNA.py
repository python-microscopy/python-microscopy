...
def widefield_pupil_and_propagator(dx = 5, X=None, Y=None, lamb=700, n=1.51, NA = 1.47, apodization='sine'):
    """
...
def clipped_widefield_pupil_and_propagator(dx = 5, X=None, Y=None, lamb=700, n=1.51, NA = 1.47, field_x=0, field_y=0,
                                           apertureNA=1.5, apertureZGradient = 0, apodization='sine'):
    """
    ...
    X, Y, R, FP, M, u, v = widefield_pupil_and_propagator(dx = dx, X=X, Y=Y, lamb=lamb, n=n, NA = NA, apodization=apodization)

    FP = FourierPropagatorClipHNA(u,v, None, lamb, n, field_x, field_y, apertureNA, apertureZGradient)
...
def GenWidefieldPSF(zs, dx=5, lamb=700, n=1.51, NA = 1.47,apodization=None):
    X, Y, R, FP, F, u, v = widefield_pupil_and_propagator(dx, lamb=lamb, n=n, NA = NA, apodization=apodization)
...
def Gen4PiPSF(zs, dx=5, lamb=700, n=1.51, NA = 1.47,apodization=None, phi=0, X=None, Y=None):
    X, Y, R, FP, F, u, v = widefield_pupil_and_propagator(dx, X, Y, lamb=lamb, n=n, NA = NA, apodization=apodization)
...
def GenWidefieldPSFA(zs, dx=5, lamb=700, n=1.51, NA = 1.47,field_x=0, field_y=0, apertureNA=1.5, apertureZGradient = 0):
    X, Y, R, FP, F, u, v = clipped_widefield_pupil_and_propagator(dx, lamb=lamb, n=n, NA = NA, field_x=field_x, field_y=field_y, apertureNA=apertureNA, apertureZGradient = apertureZGradient)
...
def GenZernikePSF(zs, dx = 5, zernikeCoeffs = []):
    ...
    X, Y, R, FP, F, u, v = widefield_pupil_and_propagator(dx)
...
def GenZernikeDAPSF(zs, dx = 5, X=None, Y=None, zernikeCoeffs = {}, lamb=700, n=1.51, NA = 1.47, ns=1.51,field_x=0, field_y=0, apertureNA=1.5, apertureZGradient = 0, apodizisation=None, vect=True):
    from PYME.misc import zernike, snells
    X, Y, R, FP, F, u, v = clipped_widefield_pupil_and_propagator(dx, X = X, Y=Y, lamb=lamb, n = n, NA = NA, field_x=field_x, field_y=field_y, apertureNA=apertureNA, apertureZGradient = apertureZGradient, apodizisation=apodizisation)
...
def GenICPRIPSF(zs, dx = 5, strength=1.0, NA=1.47):
    X, Y, R, FP, F, u, v = widefield_pupil_and_propagator(dx, NA = NA)
...
def GenAstigPSF(zs, dx=5, strength=1.0, X=None, Y=None, lamb=700, n=1.51, NA = 1.47):
    X, Y, R, FP, F, u, v = widefield_pupil_and_propagator(dx, X, Y, lamb=lamb, n=n, NA = NA)
...
def GenSAAstigPSF(zs, dx=5, strength=1.0, SA=0, X=None, Y=None, lamb=700, n=1.51, NA = 1.47):
    ...
    if not Xk in fps.keys():
        fpset = widefield_pupil_and_propagator(dx, X, Y, lamb=lamb, n=n, NA = NA)
...
def GenCubicPhasePSF(zs, dx=5, strength=1.0, X = None, Y = None, n=1.51, NA = 1.47):
    X, Y, R, FP, F, u, v = widefield_pupil_and_propagator(dx, X, Y, n = n, NA = NA)

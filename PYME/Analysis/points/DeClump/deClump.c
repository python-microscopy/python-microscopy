...
/*
Aggregate data into clumps by taking the maximum. This assumes data has been sorted by clumpIndex
*/
static PyObject * aggregateMax(PyObject *self, PyObject *args, PyObject *keywds)
{
	PyObject *clumpIDO = 0;
	PyObject *varO = 0;
	//PyObject *sigmaO = 0;
...
static PyMethodDef deClumpMethods[] = {
    ...
    "Aggregate data into clumps by taking the minimum. This assumes data has been sorted by clumpIndex."},
    { "aggregateMax", aggregateMax, METH_VARARGS | METH_KEYWORDS,
	"Aggregate data into clumps by taking the maximum. This assumes data has been sorted by clumpIndex." },

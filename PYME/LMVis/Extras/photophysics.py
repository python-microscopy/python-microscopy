...
class DecayAnalyser:
    def __init__(self, visFr):
        ...
        visFr.AddMenuItem('Extras>Photophysics', "Estimate decay lifetimes", self.OnCalcDecays)
        visFr.AddMenuItem('Extras>Photophysics', "Retrieve Intensity steps", self.OnRetrieveIntensitySteps)

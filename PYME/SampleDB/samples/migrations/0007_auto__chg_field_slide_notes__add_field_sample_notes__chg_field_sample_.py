...
###############
# 0007_auto__chg_field_slide_notes__add_field_sample_notes__chg_field_sample_.py
#
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Slide.notes'
        db.alter_column('samples_slide', 'notes', self.gf('django.db.models.fields.TextField')(blank=True))

        # Adding field 'Sample.notes'
        db.add_column('samples_sample', 'notes', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Changing field 'Sample.patientID'
        db.alter_column('samples_sample', 'patientID', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True))

        # Changing field 'Species.strain'
        db.alter_column('samples_species', 'strain', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True))


    def backwards(self, orm):
        
        # Changing field 'Slide.notes'
        db.alter_column('samples_slide', 'notes', self.gf('django.db.models.fields.TextField')())

        # Deleting field 'Sample.notes'
        db.delete_column('samples_sample', 'notes')

        # Changing field 'Sample.patientID'
        db.alter_column('samples_sample', 'patientID', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'Species.strain'
        db.alter_column('samples_species', 'strain', self.gf('django.db.models.fields.CharField')(max_length=200))

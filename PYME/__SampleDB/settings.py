...
DATABASE_HOST = 'phy-lmsrv1'             # Set to empty string for localhost. Not used with sqlite3.
...
MEDIA_ROOT = '/'.join(os.path.split(__file__)[0].split(os.sep)) + '/media/'
...
TEMPLATE_DIRS = (
    ...
    '/'.join(os.path.split(__file__)[0].split(os.sep)) + '/templates'
)

...
DESCRIPTION = 'Ratiometric multi-colour 2D Gaussian fit.'
LONG_DESCRIPTION = 'Ratiometric multi-colour 2D Gaussian fit. Uses shiftfield to correct chromatic shift during the fit. Includes a background term in the fit term, so is usable when not performing background subtraction. If subtracting background SplitterFitNR or SplitterFitQR will perform better.'

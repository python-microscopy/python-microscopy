/* Generated by Cython 0.12.1 on Fri Mar 25 12:58:10 2011 */
...
#endif
#include <math.h>
#define __PYX_HAVE_API__PYMEo__Simulation__ChemDE__countEvents
#include "stdlib.h"
#include "stdio.h"
...
/* Module declarations from PYMEo.Simulation.ChemDE.countEvents */

static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_5numpy_int32_t = { "numpy.int32_t", NULL, sizeof(__pyx_t_5numpy_int32_t), 'I' };
#define __Pyx_MODULE_NAME "PYMEo.Simulation.ChemDE.countEvents"
int __pyx_module_is_main_PYMEo__Simulation__ChemDE__countEvents = 0;

/* Implementation of PYMEo.Simulation.ChemDE.countEvents */
...
/* "/home/david/PYME/PYMEo/Simulation/ChemDE/countEvents.pyx":14
 * cimport numpy as np
 * 
...
static PyObject *__pyx_pf_5PYMEo_10Simulation_6ChemDE_11countEvents_countEvents(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pf_5PYMEo_10Simulation_6ChemDE_11countEvents_countEvents(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyArrayObject *__pyx_v_trace = 0;
  int __pyx_v_threshold;
  int __pyx_v_nEvents;
  int __pyx_v_lastObs;
  Py_ssize_t __pyx_v_i;
  Py_buffer __pyx_bstruct_trace;
  Py_ssize_t __pyx_bstride_0_trace = 0;
  Py_ssize_t __pyx_bshape_0_trace = 0;
  ...
  static PyObject **__pyx_pyargnames[] = {&__pyx_n_s__trace,&__pyx_n_s__threshold,0};
  __Pyx_RefNannySetupContext("countEvents");
  ...
  if (unlikely(__pyx_kwds)) {
    ...
    switch (PyTuple_GET_SIZE(__pyx_args)) {
      case  0:
      values[0] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__trace);
      ...
      if (likely(values[1])) kw_args--;
        ...
        __Pyx_RaiseArgtupleInvalid("countEvents", 1, 2, 2, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    }
    if (unlikely(kw_args > 0)) {
      if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, PyTuple_GET_SIZE(__pyx_args), "countEvents") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    }
    __pyx_v_trace = ((PyArrayObject *)values[0]);
    __pyx_v_threshold = __Pyx_PyInt_AsInt(values[1]); if (unlikely((__pyx_v_threshold == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  } else if (PyTuple_GET_SIZE(__pyx_args) != 2) {
    goto __pyx_L5_argtuple_error;
  } else {
    __pyx_v_trace = ((PyArrayObject *)PyTuple_GET_ITEM(__pyx_args, 0));
    __pyx_v_threshold = __Pyx_PyInt_AsInt(PyTuple_GET_ITEM(__pyx_args, 1)); if (unlikely((__pyx_v_threshold == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("countEvents", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("PYMEo.Simulation.ChemDE.countEvents.countEvents");
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __Pyx_INCREF((PyObject *)__pyx_v_trace);
  __pyx_bstruct_trace.buf = NULL;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_trace), __pyx_ptype_5numpy_ndarray, 1, "trace", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_trace, (PyObject*)__pyx_v_trace, &__Pyx_TypeInfo_nn___pyx_t_5numpy_int32_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_bstride_0_trace = __pyx_bstruct_trace.strides[0];
  __pyx_bshape_0_trace = __pyx_bstruct_trace.shape[0];

  /* "/home/david/PYME/PYMEo/Simulation/ChemDE/countEvents.pyx":18
 *     cdef Py_ssize_t i
 * 
 *     nEvents = 0             # <<<<<<<<<<<<<<
 *     lastObs = -100000
 ...
 */
  ...
  /* "/home/david/PYME/PYMEo/Simulation/ChemDE/countEvents.pyx":19
 * 
 *     nEvents = 0
 *     lastObs = -100000             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_v_lastObs = -100000;

  /* "/home/david/PYME/PYMEo/Simulation/ChemDE/countEvents.pyx":21
 *     lastObs = -100000
 * 
 *     for i in range(trace.shape[0]):             # <<<<<<<<<<<<<<
 *         if trace[i]:
 ...
 */
  __pyx_t_1 = (__pyx_v_trace->dimensions[0]);
  for (__pyx_t_2 = 0; __pyx_t_2 < __pyx_t_1; __pyx_t_2+=1) {
    __pyx_v_i = __pyx_t_2;

    /* "/home/david/PYME/PYMEo/Simulation/ChemDE/countEvents.pyx":22
 * 
 *     for i in range(trace.shape[0]):
 *         if trace[i]:             # <<<<<<<<<<<<<<
 *             if (i- lastObs) >= threshold:
 ...
 */
    ...
    __pyx_t_4 = -1;
    if (__pyx_t_3 < 0) {
      __pyx_t_3 += __pyx_bshape_0_trace;
      if (unlikely(__pyx_t_3 < 0)) __pyx_t_4 = 0;
    } else if (unlikely(__pyx_t_3 >= __pyx_bshape_0_trace)) __pyx_t_4 = 0;
    if (unlikely(__pyx_t_4 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_4);
      {__pyx_filename = __pyx_f[0]; __pyx_lineno = 22; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
    __pyx_t_5 = (*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_int32_t *, __pyx_bstruct_trace.buf, __pyx_t_3, __pyx_bstride_0_trace));
    if (__pyx_t_5) {

      /* "/home/david/PYME/PYMEo/Simulation/ChemDE/countEvents.pyx":23
 *     for i in range(trace.shape[0]):
 *         if trace[i]:
 *             if (i- lastObs) >= threshold:             # <<<<<<<<<<<<<<
 *                 nEvents += 1
 *             lastObs = i
 */
      __pyx_t_6 = ((__pyx_v_i - __pyx_v_lastObs) >= __pyx_v_threshold);
      if (__pyx_t_6) {

        /* "/home/david/PYME/PYMEo/Simulation/ChemDE/countEvents.pyx":24
 *         if trace[i]:
 *             if (i- lastObs) >= threshold:
 *                 nEvents += 1             # <<<<<<<<<<<<<<
 *             lastObs = i
 ...
 */
      ...
      /* "/home/david/PYME/PYMEo/Simulation/ChemDE/countEvents.pyx":25
 *             if (i- lastObs) >= threshold:
 *                 nEvents += 1
 *             lastObs = i             # <<<<<<<<<<<<<<
 *     return nEvents
 * 
 */
      __pyx_v_lastObs = __pyx_v_i;
      goto __pyx_L8;
    }
    __pyx_L8:;
  }

  /* "/home/david/PYME/PYMEo/Simulation/ChemDE/countEvents.pyx":26
 *                 nEvents += 1
 *             lastObs = i
 *     return nEvents             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __pyx_t_7 = PyInt_FromLong(__pyx_v_nEvents); if (unlikely(!__pyx_t_7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 26; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  { PyObject *__pyx_type, *__pyx_value, *__pyx_tb;
    ...
    __Pyx_SafeReleaseBuffer(&__pyx_bstruct_trace);
...
static struct PyMethodDef __pyx_methods[] = {
  {__Pyx_NAMESTR("countEvents"), (PyCFunction)__pyx_pf_5PYMEo_10Simulation_6ChemDE_11countEvents_countEvents, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(0)},
  {0, 0, 0, 0}
};
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initcountEvents(void); /*proto*/
PyMODINIT_FUNC initcountEvents(void)
#else
PyMODINIT_FUNC PyInit_countEvents(void); /*proto*/
PyMODINIT_FUNC PyInit_countEvents(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  #if CYTHON_REFNANNY
  ...
  __pyx_refnanny = __Pyx_RefNanny->SetupContext("PyMODINIT_FUNC PyInit_countEvents(void)", __LINE__, __FILE__);
  #endif
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("countEvents"), __pyx_methods, 0, 0, PYTHON_API_VERSION);
  #else
  ...
  if (__pyx_module_is_main_PYMEo__Simulation__ChemDE__countEvents) {
  ...
  /* "/home/david/PYME/PYMEo/Simulation/ChemDE/countEvents.pyx":11
 * #
 * ##################
 * import numpy as np             # <<<<<<<<<<<<<<
 * cimport numpy as np
 ...
 */
  ...
  /* "/home/david/PYME/PYMEo/Simulation/ChemDE/countEvents.pyx":1
 * #!/usr/bin/python             # <<<<<<<<<<<<<<
 * ##################
 * # countStates.py
 */
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_1);
  if (__pyx_m) {
    __Pyx_AddTraceback("init PYMEo.Simulation.ChemDE.countEvents");
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init PYMEo.Simulation.ChemDE.countEvents");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3

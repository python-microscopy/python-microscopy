...
###############
# 0006_auto__del_field_dye_dyeID__add_field_dye_id__del_field_sample_sampleID.py
#
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Dye.dyeID'
        #db.delete_column('samples_dye', 'dyeID')

        # Adding field 'Dye.id'
        db.add_column('samples_dye', 'id', self.gf('django.db.models.fields.AutoField')(primary_key=True), keep_default=False)

        # Deleting field 'Sample.sampleID'
        db.delete_column('samples_sample', 'sampleID')

        # Adding field 'Sample.id'
        db.add_column('samples_sample', 'id', self.gf('django.db.models.fields.AutoField')(primary_key=True), keep_default=False)

        # Deleting field 'Species.speciesID'
        db.delete_column('samples_species', 'speciesID')

        # Adding field 'Species.id'
        db.add_column('samples_species', 'id', self.gf('django.db.models.fields.AutoField')(primary_key=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Dye.dyeID'
        db.add_column('samples_dye', 'dyeID', self.gf('django.db.models.fields.IntegerField')(default=0, primary_key=True), keep_default=False)

        # Deleting field 'Dye.id'
        db.delete_column('samples_dye', 'id')

        # Adding field 'Sample.sampleID'
        db.add_column('samples_sample', 'sampleID', self.gf('django.db.models.fields.IntegerField')(default=0, primary_key=True), keep_default=False)

        # Deleting field 'Sample.id'
        db.delete_column('samples_sample', 'id')

        # Adding field 'Species.speciesID'
        db.add_column('samples_species', 'speciesID', self.gf('django.db.models.fields.IntegerField')(default=0, primary_key=True), keep_default=False)

        # Deleting field 'Species.id'
        db.delete_column('samples_species', 'id')

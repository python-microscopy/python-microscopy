...
.. note::
   ...
   and Python 3. The `PYMEClusterOfOne` is for the most part a drop-in replacement. 
   Still, legacy documentation for localization analysis can be found `here <localisationanalysis>`.

...
z(6, 'r*(-2 + 3*r**2)*cos(2*theta)', 'Coma x')
z(7, 'r*(-2 + 3*r**2)*sin(2*theta)', 'Coma y')
...
z(12, 'r**2*(-3 + 4*r**2)*cos(2*theta)', 'Astig2 y')
z(13, 'r*(3 - 12*r**2 + 10*r**4)*cos(theta)', 'Coma2 x')
z(14, 'r*(3 - 12*r**2 + 10*r**4)*sin(theta)', 'Coma2 x')
z(15, '-1 + 12*r**2 - 30*r**4 + 20*r**6', 'Spherical2')
z(16, 'r**4*cos(4*theta)', 'Tetrafoil x')
z(17, 'r**4*sin(4*theta)', 'Tetrafoil y')
z(18, 'r**3*(-4 + r**2)*cos(3*theta)', 'Trefoil2 x')
z(19, 'r**3*(-4 + r**2)*sin(3*theta)', 'Trefoil2 y')
z(20, 'r**2*(6 - 20*r**2 + 15*r**4)*cos(2*theta)', 'Astig3 x')
z(21, 'r**2*(6 - 20*r**2 + 15*r**4)*sin(2*theta)', 'Astig3 y')
z(22, 'r*(-4 + 30*r**3 - 60*r**4 + 35*r**6)*cos(theta)', 'Coma3 x')
z(23, 'r*(-4 + 30*r**3 - 60*r**4 + 35*r**6)*sin(theta)', 'Coma3 y')
